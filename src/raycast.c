...
/*   Updated: 2022/10/04 15:57:01 by kfum             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Set the wall height base on the raycast value
*/
static void	wall_height(t_wolf *maze, t_raycast *ray)
{
	if (ray->direction == 0)
	{
